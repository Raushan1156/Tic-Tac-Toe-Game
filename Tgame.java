...
class Tgame extends JFrame 
{
	...
	{
		/*setEnabled(false) disables a text field completely. 
		setEditable(false) still allows selecting and copying its content,
		 but doesn't allow modifying its value*/
		b1.setEnabled(false);
		b2.setEnabled(false);
		b3.setEnabled(false);
		b4.setEnabled(false);
	...
	// checking each and every possibilities
	public int check()
	{
		count++;		
